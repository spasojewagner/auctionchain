<?php $__env->startSection('title', 'Registracija'); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <p class="text-center mb-0">
                    Već imate nalog? <a href="<?php echo e(route('login')); ?>">Prijavite se</a>
                </p>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Metoda\Desktop\auctionchain\resources\views/auth/register.blade.php ENDPATH**/ ?>