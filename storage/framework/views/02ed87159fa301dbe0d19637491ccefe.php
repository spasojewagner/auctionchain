        ...
        <div class="row align-items-center">
            <div class="col-md-7">
                ...
                <div class="d-flex gap-3 flex-wrap">
                    <a href="<?php echo e(route('auctions.index')); ?>" class="btn btn-light btn-lg">
                        <i class="fas fa-search me-2"></i>Pregledaj aukcije
                    </a>
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(route('auctions.create')); ?>" class="btn btn-outline-light btn-lg">
                            <i class="fas fa-plus me-2"></i>Postavi aukciju
                        </a>
                    <?php else: ?>
                        <a href="<?php echo e(route('register')); ?>" class="btn btn-outline-light btn-lg">Registruj se</a>
                    <?php endif; ?>
                </div>
            </div>
...
<div class="container">
                ...
                <div class="col-md-3 col-sm-6">
                    <a href="<?php echo e(route('auctions.index', ['category' => $category->id])); ?>"
                       ...
                       style="border: 1px solid #e2e8f0; transition: all 0.2s;">
                        ...
                        <small class="text-muted"><?php echo e($category->auctions_count); ?> aktivnih</small>
                    </a>
                </div>
    ...
    <section class="mb-5">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="<?php echo e(route('auctions.index')); ?>" class="btn btn-outline-primary btn-sm">Vidi sve</a>
        </div>
        <div class="row g-4">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Metoda\Downloads\auctionchain\auctionchain\resources\views/home.blade.php ENDPATH**/ ?>