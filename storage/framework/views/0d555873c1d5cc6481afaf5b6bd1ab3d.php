                ...
                <table role="presentation" width="560" cellpadding="0" cellspacing="0" style="background:#ffffff; border-radius:12px; overflow:hidden; max-width:560px; width:100%;">
                    ...
                    <tr>
                        <td style="padding:32px;">
                            ...
                            <?php if($notification->auction): ?>
                                <a href="<?php echo e(route('auctions.show', $notification->auction)); ?>"
                    ...
                    <tr>
                        <td style="padding:20px 32px; background:#0f172a; color:#94a3b8; font-size:12px;">
                            AuctionChain &copy; <?php echo e(date('Y')); ?> — Seminarski rad, FTN Čačak.<br>
...
<?php /**PATH C:\Users\Metoda\Desktop\auctionchain\resources\views/emails/notification.blade.php ENDPATH**/ ?>