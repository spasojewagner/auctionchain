...
<div id="acb-root">
    <div class="acb-panel" id="acb-panel" role="dialog" aria-label="Pomoć">
        <div class="acb-header">
            <div>
                <h6><img src="<?php echo e(asset('images/chatbot.png')); ?>" alt="" class="acb-head-logo"> AuctionChain Pomoć</h6>
    ...
    <button class="acb-toggle" id="acb-toggle" aria-label="Otvori pomoć">
        <img src="<?php echo e(asset('images/chatbot.png')); ?>" alt="AuctionChain bot" class="acb-logo acb-icon-open">
...
(function () {
    ...
    const endpoint = "<?php echo e(route('chat')); ?>";
    const BOT_AVATAR = "<?php echo e(asset('images/chatbot.png')); ?>";
...
<?php /**PATH C:\Users\Metoda\Desktop\auctionchain\resources\views/partials/chatbot.blade.php ENDPATH**/ ?>