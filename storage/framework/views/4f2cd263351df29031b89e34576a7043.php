        ...
        <div class="col-md-7">
            ...
            <div class="form-card">
                ...
                <div class="row text-muted small">
                    <div class="col-md-6">
                        <strong>Prodavac:</strong> <?php echo e($auction->seller->name); ?>

                    </div>
                    <div class="col-md-6">
                        <strong>Postavljeno:</strong> <?php echo e($auction->starts_at->format('d.m.Y H:i')); ?>

                    </div>
                    <div class="col-md-6 mt-2">
                        <strong>Početna cena:</strong> <?php echo e(number_format((float) $auction->starting_price, 2)); ?> RSD
                    </div>
                    <div class="col-md-6 mt-2">
                        <strong>Završetak:</strong> <?php echo e($auction->ends_at->format('d.m.Y H:i')); ?>
            ...
            <div class="bid-form mb-4">
                ...
                <?php if($auction->isActive()): ?>
                    <?php if(auth()->guard()->check()): ?>
                        ...
                        <?php endif; ?>
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="btn btn-primary-custom w-100">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Metoda\Downloads\auctionchain\auctionchain\resources\views/auctions/show.blade.php ENDPATH**/ ?>